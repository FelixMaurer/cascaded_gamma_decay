...
st.info(
    ...
    **Important interpretation note**
    ...
    - **Vectors:** Show the addition of angular momentum, not literal rigid arrows in space.
...
def plot_3d_state(state_name, vectors, show_orbits, show_vectors, show_charge, show_core, beta, radii, colors, names):
    ...
    total_j = np.zeros(3)
    vector_scale = 1.8 # Multiplier to make vectors longer and more visible
    ...
    for i, v in enumerate(vectors):
        ...
        # Determine if we need to add this to the legend
...
# =====================================================================
# State Configurations (Vectors, Radii, Colors, Labels)
# =====================================================================

# J=4: 3 neutrons in p3/2 (inner), 1 excited into f5/2 (outer). Aligned Z.
vectors_J4 = [[0.3, 0, 1.0], [-0.3, 0, 1.0], [0, 0.3, 1.0], [0, -0.3, 1.0]] 
radii_J4   = [1.5, 1.5, 1.5, 2.2]
colors_J4  = ["cyan", "cyan", "cyan", "lime"]
names_J4   = ["p3/2", "p3/2", "p3/2", "f5/2"]

# J=2: 2 p3/2 neutrons pair off (XY plane), 1 p3/2 and 1 f5/2 remain partially aligned.
vectors_J2 = [[1.5, 0, 0], [-1.5, 0, 0], [0, 0.5, 1.0], [0, -0.5, 1.0]]
radii_J2   = [1.5, 1.5, 1.5, 2.2]
colors_J2  = ["cyan", "cyan", "cyan", "lime"]
names_J2   = ["p3/2", "p3/2", "p3/2", "f5/2"]

# J=0: All 4 drop to the lowest p3/2 state and perfectly pair off (cancelling).
